...
class _$PeriodImpl extends _Period {
  ...
  @override
  String toString() {
    return 'Period(id: $id, date: $date, slot: $slot, subject: $subject, grade: $grade, homework: $homework)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, date, slot, subject, grade, homework);
...
abstract class _Period extends Period {
  const factory _Period(
      ...
      required final Homework homework}) = _$PeriodImpl;
